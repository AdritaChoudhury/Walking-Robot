...
GLfloat mat_ambient2[] ={1.0,1.0,.0};
...
GLfloat mat_ambient3[] ={0.0, 0.0, 0.0};
GLfloat mat_diffuse3[] ={1.0, 0.0, 0.0};
GLfloat mat_shininess3[] ={0.0 * 0.0};
//to change the plateform color
GLfloat mat_specular4[] = {1.0, 0.8, 0.0};
GLfloat mat_ambient4[] = {1.0, 0.5, 0.0};
GLfloat mat_diffuse4[] = {1.0, 0.61424, 0.0};
GLfloat mat_shininess4[] = {128 * 0.6};

GLfloat mat_specular5[] ={0.0, 0.0, 0.0};
GLfloat mat_ambient5[] ={0.0, 0.0, 0.0};
GLfloat mat_diffuse5[] ={0.0, 0.0, 0.0};
...
void glutMenu(void)
{
  ...
  glutAddMenuEntry("outwards      : 7,9", 0);
  glutAddMenuEntry("inwards       : 1,3", 0);
  ...
  glutAddMenuEntry("right         : 6", 0);
  glutAddMenuEntry("left          : 4", 0);
  glutAddMenuEntry("up            : 2", 0);
  glutAddMenuEntry("down          : 8", 0);
...
int main(int argc, char **argv)
{
  ...
  glutCreateWindow("glutmech: Walking Robot");
  myinit();
